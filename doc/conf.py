...
latex_documents = [
    ("index", "ch_util.tex", "ch\\_util Documentation", "CHIME Collaboration", "manual")
]
...
man_pages = [("index", "ch_util", "ch_util Documentation", ["CHIME Collaboration"], 1)]
